...
const CustomPlaylists = () => {
    ...
    const createList = async (e) => {
        ...
        if(newPlaylist !== ""){
            ...
            const res = await axios.post("https://musixxxx.herokuapp.com/createPlaylist",{newPlaylist} , {
                headers : {
                    token : token
                }
            })
    ...
    const deletePlaylist = async (playlist) => {
        const res = await axios.post("https://musixxxx.herokuapp.com/deletePlaylist",{playlist},{
            headers : {
                token : token
            }
        })
