...
const Search = () => {
    ...
    const addFav = async (track) => {
        ...
        const token = localStorage.getItem("user-token")
        const res = await axios.post('https://musixx.onrender.com/addFavs', trackData, {
            headers: {
                token: token
            }
        })
    ...
    const removeFav = async (id) => {
        const token = localStorage.getItem("user-token")
        const res = await axios.post('https://musixx.onrender.com/removeFavs', { id }, {
            headers: {
                token: token
            }
        })
    ...
    const addToCustomPlaylist = async (track, playlist) => {
        ...
        const res = await axios.post("https://musixx.onrender.com/addTrackToPlaylist", data, {
            headers: {
                token: token
            }
        })
